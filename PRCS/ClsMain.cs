...
namespace PRCS
{
    class ClsMain
    {
        ...
        public SqlConnection GblCon = new SqlConnection("Persist Security Info=False;User ID=sa;Password='power@2012';Initial Catalog='PRCS';Data Source='.\\mssql12';");
        //public SqlConnection GblCon = new SqlConnection("Persist Security Info=False;User ID=sa;Password='" + ClsVar.SqlPassword + "' + ClsVar.SqlPassword + "';Initial Catalog='" + ClsVar.DataBaseName + "';Data Source='" + ClsVar.ServerName + "';Connection Timeout=200;");
